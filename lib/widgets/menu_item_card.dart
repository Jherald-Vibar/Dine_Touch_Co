      ...
      child: InkWell(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              // Image placeholder / food emoji area
              Container(
                height: 100,
...
class _Tag extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isHot ? const Color(0xFFFAEEDA) : AppTheme.primaryLight,
      ...
      child: Text(
        ...
        style: TextStyle(
          fontSize: 10,
          fontWeight: FontWeight.w600,
          color: isHot ? AppTheme.warning : AppTheme.primaryDark,
        ),
      ),
    );
  }
    ...
    return Row(
      children: [
        ...
        Padding(
          ...
          child: Text('$qty', style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w700)),
        ),
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Center(child: Text(_foodEmoji(widget.item.category), style: const TextStyle(fontSize: 72))),
          ),
          ...
          Row(
            ...
            children: [
              Expanded(
                child: Text(widget.item.name, style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w700)),
              ),
          ...
          Text(widget.item.description, style: const TextStyle(fontSize: 14, color: AppTheme.textSecondary, height: 1.5)),
          const SizedBox(height: 16),
          TextField(
            ...
            child: ElevatedButton(
              onPressed: () {
                ...
                if (_controller.text.isNotEmpty) {
                  widget.cart.setSpecialRequest(widget.item.id, _controller.text);
                }
